...
static CANMsgMap rxStreamedMsgMap = {
    {CANID::ARM_SET_JOINT_POSITION,
     {
         {CANSIGNAL::ARM_SET_TURNTABLE_POSITION,
          (CANSignalValue_t)ARM_SET_TURNTABLE_POSITION_VALUES::ARM_SET_TURNTABLE_POSITION_SNA},
         {CANSIGNAL::ARM_SET_SHOULDER_POSITION,
          (CANSignalValue_t)ARM_SET_SHOULDER_POSITION_VALUES::ARM_SET_SHOULDER_POSITION_SNA},
         {CANSIGNAL::ARM_SET_ELBOW_POSITION,
          (CANSignalValue_t)ARM_SET_ELBOW_POSITION_VALUES::ARM_SET_ELBOW_POSITION_SNA},
         {CANSIGNAL::ARM_SET_LEFT_WRIST_POSITION,
          (CANSignalValue_t)ARM_SET_LEFT_WRIST_POSITION_VALUES::ARM_SET_LEFT_WRIST_POSITION_SNA},
         {CANSIGNAL::ARM_SET_RIGHT_WRIST_POSITION,
          (CANSignalValue_t)ARM_SET_RIGHT_WRIST_POSITION_VALUES::ARM_SET_RIGHT_WRIST_POSITION_SNA},
         {CANSIGNAL::ARM_SET_CLAW_POSITION, (CANSignalValue_t)ARM_SET_CLAW_POSITION_VALUES::ARM_SET_CLAW_POSITION_SNA},
         {CANSIGNAL::ARM_SET_TOOL_TIP_POSITION,
          (CANSignalValue_t)ARM_SET_TOOL_TIP_POSITION_VALUES::ARM_SET_TOOL_TIP_POSITION_SNA},
     }},
    {CANID::ARM_SET_JOINT_ANGULAR_VELOCITY,
     {
         ...
         {CANSIGNAL::ARM_SET_LEFT_WRIST_ANGULAR_VELOCITY,
          (CANSignalValue_t)ARM_SET_LEFT_WRIST_ANGULAR_VELOCITY_VALUES::ARM_SET_LEFT_WRIST_ANGULAR_VELOCITY_SNA},
         {CANSIGNAL::ARM_SET_RIGHT_WRIST_ANGULAR_VELOCITY,
          (CANSignalValue_t)ARM_SET_RIGHT_WRIST_ANGULAR_VELOCITY_VALUES::ARM_SET_RIGHT_WRIST_ANGULAR_VELOCITY_SNA},
         {CANSIGNAL::ARM_SET_CLAW_ANGULAR_VELOCITY,
          (CANSignalValue_t)ARM_SET_CLAW_ANGULAR_VELOCITY_VALUES::ARM_SET_CLAW_ANGULAR_VELOCITY_SNA},
     }},
    {CANID::ARM_SET_JOINT_CURRENT,
     {
         ...
         {CANSIGNAL::ARM_SET_LEFT_WRIST_CURRENT,
          (CANSignalValue_t)ARM_SET_LEFT_WRIST_CURRENT_VALUES::ARM_SET_LEFT_WRIST_CURRENT_SNA},
         {CANSIGNAL::ARM_SET_RIGHT_WRIST_CURRENT,
          (CANSignalValue_t)ARM_SET_RIGHT_WRIST_CURRENT_VALUES::ARM_SET_RIGHT_WRIST_CURRENT_SNA},
         {CANSIGNAL::ARM_SET_CLAW_CURRENT, (CANSignalValue_t)ARM_SET_CLAW_CURRENT_VALUES::ARM_SET_CLAW_CURRENT_SNA},
     }},
};
