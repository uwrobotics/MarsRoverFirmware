...
class TutorialServo {
 public:
  // Constructor: Takes a servo pin name (ex. PA_1), and optionally a servo range   // that has a default value of 180.0
  // degrees, a minimum pulsewidth of 1ms, and a   // maximum pulsewidth of 2ms.
