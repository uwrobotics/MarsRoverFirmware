...
static Controller::Velocity vel(&motor, &encoder, std::nullopt, &velPID, maxDegPerSec, maxCurrent, ELVTR_SW_3,
                                ELVTR_SW_4);
static Controller::Position pos(&motor, &encoder, std::nullopt, &posPID, maxDegPerSec, maxCurrent, ELVTR_SW_3,
                                ELVTR_SW_4);
