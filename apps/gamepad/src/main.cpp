...
int main() {
  ...
  while (1) {
    ...
    printf("Digital Inputs: JOY_BTN: %d, valid: %d\r\n", btns_values & 0x1, btns_invalid_reads & 0x1);
    printf("Digital Inputs: PB1: %d, valid: %d\r\n", (btns_values & 0x1 << 1) >> 1,
           (btns_invalid_reads & 0x1 << 1) >> 1);
    printf("Digital Inputs: PB2: %d, valid: %d\r\n", (btns_values & 0x1 << 2) >> 2,
           (btns_invalid_reads & 0x1 << 2) >> 2);
    printf("Digital Inputs: SW_1A: %d, valid: %d\r\n", switches_values & 0x1, switches_invalid_reads & 0x1);
    printf("Digital Inputs: SW_1B: %d, valid: %d\r\n", (switches_values & 0x1 << 1) >> 1,
           (switches_invalid_reads & 0x1 << 1) >> 1);
    printf("Digital Inputs: SW_2A: %d, valid: %d\r\n", (switches_values & 0x1 << 2) >> 2,
           (switches_invalid_reads & 0x1 << 2) >> 2);
    printf("Digital Inputs: SW_2B: %d, valid: %d\r\n", (switches_values & 0x1 << 3) >> 3,
           (switches_invalid_reads & 0x1 << 3) >> 3);

    printf("Digital Inputs: JOY_SM_X: %f\r\n", joys_values[0]);
    printf("Digital Inputs: JOY_SM_Y: %f\r\n", joys_values[1]);
    printf("Digital Inputs: JOY_X: %f\r\n", joys_values[2]);
    printf("Digital Inputs: JOY_Y: %f\r\n", joys_values[3]);
    printf("Digital Inputs: POT_AL: %f\r\n", pots_values[0]);
    printf("Digital Inputs: SLIDE_POT_AL: %f\r\n", pots_values[1]);
